...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__assets_normalize_css__ = __webpack_require__(11);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__assets_normalize_css___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__assets_normalize_css__);
    ...
    data() {
        return {
            ...
            resume: {
                ...
                awards: [{ name: 'awards A', content: '文字' }, { name: 'awards B', content: '文字' }],
      ...
      return _c('div', {
        ...
        on: {
          "input": function($event) {
            ...
            _vm.$set(_vm.resume[item.field], key, $event.target.value)
          }
        }
      })])
    })], 2)
...
//# sourceMappingURL=app.4a24220d174d048f2222.js.map